...
mixin _$Fresh<T> {
  ...
  bool? get isNextPageAvailabel => throw _privateConstructorUsedError;
...
abstract class $FreshCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T entity, bool isFresh, bool? isNextPageAvailabel});
}
...
class _$FreshCopyWithImpl<T, $Res, $Val extends Fresh<T>>
  ...
  $Res call({
    ...
    Object? isFresh = null,
    Object? isNextPageAvailabel = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      isFresh: null == isFresh
          ...
          : isFresh // ignore: cast_nullable_to_non_nullable
              as bool,
      isNextPageAvailabel: freezed == isNextPageAvailabel
          ? _value.isNextPageAvailabel
          : isNextPageAvailabel // ignore: cast_nullable_to_non_nullable
              as bool?,
    ) as $Val);
  }
}
...
class _$_Fresh<T> implements _Fresh<T> {
  const _$_Fresh(
      {required this.entity, required this.isFresh, this.isNextPageAvailabel});
  ...
  final bool isFresh;
  @override
  final bool? isNextPageAvailabel;

  @override
  String toString() {
    return 'Fresh<$T>(entity: $entity, isFresh: $isFresh, isNextPageAvailabel: $isNextPageAvailabel)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isNextPageAvailabel, isNextPageAvailabel) ||
                other.isNextPageAvailabel == isNextPageAvailabel));
  }
...
abstract class _Fresh<T> implements Fresh<T> {
  const factory _Fresh(
      ...
      final bool? isNextPageAvailabel}) = _$_Fresh<T>;
